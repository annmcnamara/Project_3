...
4.	The United States has been very badly affected and remains an area of concern given the fact that the US accounts for nearly one-quarter of all deaths.  Over the last three months the cases have grown at an alarming rate from round 300,000 to 3.2 Million. 
5.	
